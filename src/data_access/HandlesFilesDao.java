...
public class HandlesFilesDao {
    ...
    public void findPersonInfo() {
        ...
        String pathFile = library.checkInputPathFile("path file");
        lp = getListPerson(pathFile);
        double money = library.checkInputMoney();
        printListPerson(lp, money);
    }

    //allow user copy text to new file
    public void coppyNewFile() {
        String pathFileInput = library.checkInputPathFile("source");
        String pathFileOutput = library.checkInputPathFile("new file name");
